					...
					<table class="table table-bordered table-striped">
						<tbody>
							<tr>
								...
								<td width="180">${newDeptCheckViewData.deptName}</td>
							</tr>
						</tbody>
					</table>
					<br> <input type="hidden" name="name"
						value="${newDeptCheckViewData.deptName}">
					<div style="display: inline-flex;">
						<button type="submit"
							formaction="<%=request.getContextPath()%>/deptregistcheck"
							class="btn btn-primary btn-lg m-3" name="regist">登録</button>
						<button type="submit"
							formaction="<%=request.getContextPath()%>/deptregistreinput"
